    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <Button
            ...
            size="icon"
            className={cn(
              "h-8 w-8 shrink-0 text-teal-600 hover:text-teal-700 hover:bg-teal-50",
              !sidebarOpen && "mx-auto"
            )}
        ...
        <div
          className={cn(
            ...
            sidebarOpen
              ? "opacity-100 pt-3 max-h-40 delay-300"
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2">
              <Select
                ...
                onValueChange={(value) =>
                  setSelectedStatus(value as CaseStatus | "all")
                }
              >
      ...
      <div
        className={cn(
          ...
          sidebarOpen
            ? "opacity-100 overflow-y-auto delay-300"
            : "opacity-0 delay-0"
        )}
      >
              ...
              <li key={caseItem.id}>
                ...
                >
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    <Badge
                      variant={statusBadgeVariant[caseItem.status]}
                      className="shrink-0"
                    >
                  ...
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    <span>
                      {caseItem.sandboxType &&
                        SANDBOX_TYPE_LABELS[caseItem.sandboxType]}
                    </span>
