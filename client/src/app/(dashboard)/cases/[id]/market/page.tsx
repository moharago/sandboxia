    ...
    return (
        <div className="py-6">
            {isSaving && (
                <AILoadingOverlay
                    message={
                        selectedDecision === "direct" ? "저장 중" : "AI 분석 중"
                    }
                />
            )}
            <div className="container mx-auto px-4 space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        AI가 서비스의 규제 현황을 분석하여 시장 출시 가능 여부를
                        판단합니다
                    </p>
                </div>
                    ...
                    <CardContent>
                        <div className="divide-y divide-border">
                            {analysisData.reasons.map(
                                (reason: AnalysisReason, index) => {
                                    const config =
                                        CATEGORY_CONFIG[reason.category];
                                    return (
                                        <div
                                            key={index}
                                            className={cn(
                    ...
                    <Card className="border-amber-200">
                        ...
                        <CardContent>
                            <ul className="space-y-2">
                                {analysisData.directLaunchRisks.map(
                                    (risk, index) => (
                                        <li
                                            key={index}
