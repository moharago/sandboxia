...
export default function DashboardPage() {
  ...
  const pipelineSteps = [
    ...
    { id: "draft" as PipelineFilter, label: "신청서작성", count: stats.draft },
    {
    ...
    let result = cases.filter((caseItem) => {
      ...
      if (statusFilter !== "all") {
        if (statusFilter === "done") {
          matchesStatus =
            caseItem.status === "done" || caseItem.status === "direct";
        } else {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Select
            value={statusFilter}
            onValueChange={(value) => setStatusFilter(value as PipelineFilter)}
          >
