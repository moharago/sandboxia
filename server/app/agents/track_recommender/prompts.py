...
- "demo", "temp_permit", "quick_check"의 "reasons" 형식:
```json
{{"type": "positive|negative|neutral", "text": "추천/비추천 사유 설명"}}
```

- "demo", "temp_permit", "quick_check"의 "evidence" 형식:
```json
{{"source_type": "사례|법령|규제", "source": "출처명"}}
```
...
8. 서로 다른 트랙에서 동일한 source를 사용해도 됩니다
"""
